...
def usage():
  ...
  ketika kita mengattack website luar negri. 
  
  kita adalah bangsa yang tak terkalahkan.
  
  Selamat menggunakan Tools Kami Semoga anda
  
  mendapatkan kepintaran saat melakukan.
